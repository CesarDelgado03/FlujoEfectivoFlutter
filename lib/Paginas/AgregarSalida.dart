...
class AgregarSalida extends StatelessWidget{
  @override
  Widget build(BuildContext context) {
    return Scaffold(
        ...
        body: Padding(
          ...
          child: Column(
            children: <Widget>[
              Text('Salidas de Efectivo (Gastos)', style: TextStyle(fontSize: 24.0),),
              Padding(
                padding: const EdgeInsets.all(10.0),
                child: TextField(
                    obscureText: true,
              ...
              FlatButton(
                ...
                onPressed: () {},
                child: Text('Agregar Salida',style: TextStyle(fontSize: 18.0),),
              ),
              Container(
                width: 400,
